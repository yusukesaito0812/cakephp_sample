    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('password_confirm', ['type' => 'password', 'label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('first_name', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('last_name', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('hospital', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('ward', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('section', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->input('occupation', ['label' => false, 'class' => 'form-control']);
                    ?>
                </td>
            </tr>
        </table>
